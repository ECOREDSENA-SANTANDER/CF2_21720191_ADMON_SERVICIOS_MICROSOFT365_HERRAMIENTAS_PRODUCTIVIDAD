    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      .titulo-principal.color-acento-contenido
        .titulo-principal__numero
          span 2
        h1 Administración estratégica del correo electrónico Microsoft Outlook 365
      ...
      #t_2_1.titulo-segundo.color-acento-contenido(data-aos='fade-right')
        h2 2.1 Fundamentos conceptuales del correo corporativo como herramienta pedagógica y profesional
      p.mb-5 El correo electrónico en un entorno corporativo o académico posee características que lo diferencian sustancialmente de la mensajería instantánea informal. Mientras que las aplicaciones de chat priorizan la inmediatez y la brevedad, el correo corporativo exige estructura, trazabilidad, formalidad y claridad expositiva. Comprender esta distinción es el fundamento principal de la etiqueta digital (netiqueta) y del uso profesional de la herramienta.
      ...
      #t_2_2.titulo-segundo.color-acento-contenido(data-aos='fade-right')
        h2 2.2 Gestión avanzada y organización de la bandeja de entrada
      ...
      .titulo-tercer-nivel.mb-5(data-aos="fade-right")
            ...
            h3.titulo-tercer-nivel__text.mb-0.px-0.py-2 Caso de uso vinculado a la creación de sitios web
              ...
              ol.lista-ol--cuadro.mb-4
                li.d-flex 
                  .lista-ol--cuadro__vineta.v--green
                    span.text-bold A 
                  p.mb-0 Si el remitente es “alertas@servidor.com”, mover automáticamente el correo a la subcarpeta “Logs del servidor” y marcar como leído.
                li.d-flex 
                  .lista-ol--cuadro__vineta.v--green
                    span.text-bold B 
      ...
      .row.justify-content-center.mb-0(data-aos='fade-right')
        .col-sm-12.col-lg-6
            .titulo-sexto.color-acento-contenido
              h5 Figura 2. 
              span Diagrama de flujo para gestión de correos nuevos
            figure.mb-0
              img(src='@/assets/curso/temas/t2/11.svg', alt='El proceso inicia evaluando “¿es accionable?” si la respuesta es “No”, la acción es archivar o eliminar el correo. Si es “si”, avanza a la siguiente pregunta: “¿Toma menos de dos minutos?”. Si la respuesta es afirmativa, se debe responder de inmediato; si es negativa, la instrucción final es convertir el correo en una tarea o programarlo en el calendario.')


      Separador
      #t_2_3.titulo-segundo.color-acento-contenido(data-aos='fade-right')
        h2 2.3 Configuración, personalización y automatización del entorno de trabajo
